  ...
  return (
    <article className="wrapper article-page">
      ...
      <div className="article-text">
        <div className="text"> 
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam tortor nisi, ullamcorper et dapibus vitae, cursus a tellus. Proin egestas, nunc sit amet consequat imperdiet, metus ante accumsan est, non faucibus ex justo vitae leo. Fusce quis ex eleifend, dapibus dolor at, posuere mauris. Duis pellentesque aliquet ex, faucibus luctus nulla sagittis a. Quisque iaculis neque sed volutpat dignissim. Etiam fringilla orci lorem, ac aliquam mauris suscipit sed. <br/>
          <p className="highlight">Provident atque, aperiam assumenda tempora est hic! Saepe, harum.</p>
        ...
        <br/>
          ...
          <br/>
          <p className="highlight">Etiam lacinia, dui eleifend vehicula pulvinar, mi lorem ultrices neque.</p>
        <br/>
